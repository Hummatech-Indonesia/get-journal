    ...
    <div class="col-12 col-md-6 col-lg-3">
        <div class="card card-dashboard  position-relative overflow-hidden">
            <div class="card-body p-5">
                ...
                <div class="text-info fs-2tx fw-bold">10</div>
    ...
    <div class="col-12 col-md-6 col-lg-3">
        <div class="card card-dashboard  position-relative overflow-hidden">
            <div class="card-body p-5">
                ...
                <div class="text-primary fs-2tx fw-bold">10</div>
    ...
    <div class="col-12 col-md-6 col-lg-3">
        <div class="card card-dashboard  position-relative overflow-hidden">
            <div class="card-body p-5">
                ...
                <div class="text-success fs-2tx fw-bold">10</div>
    ...
    <div class="col-12 col-md-6 col-lg-3">
        <div class="card card-dashboard  position-relative overflow-hidden">
            <div class="card-body p-5">
                ...
                <div class="text-warning fs-2tx fw-bold">10</div>
