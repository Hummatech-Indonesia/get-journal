                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        mRender: (data, type, row) => {
                            ...
                            return `
                                <div>
                                    <button type="button" class="btn-teacher-detail btn btn-sm btn-light-primary" data-bs-toggle="modal" data-bs-target="#teacher-detail-modal" data-teacher="${str_teacher}">
                                        Detail
                                    </button>
                                </div>
                            `
