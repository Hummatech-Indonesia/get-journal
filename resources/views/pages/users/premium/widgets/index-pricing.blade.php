<div class="card">
    <div class="card-body">
        <div class="mb-13 text-center">
            <h1 class="fs-2hx fw-bold mb-5">Akun Premium</h1>
            <div class="text-gray-600 fw-semibold fs-5">Berlangganan untuk mendapatkan keuntungan yang lebih.</div>
        </div>
        <div class="row g-10">
            <!--begin::Col-->
            <div class="col-xl-4">
                <div class="d-flex h-100 align-items-center">
                    <!--begin::Option-->
                    <div class="w-100 d-flex flex-column flex-center rounded-3 bg-light-primary  py-15 px-10">
                        <!--begin::Heading-->
                        <div class="mb-7 text-center">
                            <!--begin::Title-->
                            <h1 class="text-gray-900 mb-5 fw-bolder">Gratis</h1>
                            <!--end::Title-->
                            <!--begin::Description-->
                            <div class="text-gray-600 fw-semibold mb-5">Cocok untuk perorangan, dengan sedikit jumlah siswa yang diajar 
                            </div>
                            <!--end::Description-->
                            <!--begin::Price-->
                            <div class="text-center">
                                ...
                                <span class="fs-3x fw-bold text-primary" data-kt-plan-price-month="39"
                                    data-kt-plan-price-annual="399">0</span>
                            </div>
                            <!--end::Price-->
                        </div>
                        <!--end::Heading-->
                        ...
                        <div class="w-100 mb-10">
                            ...
                            <!--begin::Item-->
                            <div class="d-flex align-items-center mb-5">
                                <span class="fw-semibold fs-6 text-gray-800 flex-grow-1 pe-3">Hingga 36 siswa per kelas</span>
                                <i class="ki-duotone ki-minus-circle fs-1 text-primary">
                                    <span class="path1"></span>
                                    <span class="path2"></span>
                                </i>
            ...
            <div class="col-xl-4">
                <div class="d-flex h-100 align-items-center">
                    <!--begin::Option-->
                    <div class="w-100 d-flex flex-column flex-center rounded-3 bg-light-primary py-20 px-10">
                        <!--begin::Heading-->
                        <div class="mb-7 text-center">
                            <!--begin::Title-->
