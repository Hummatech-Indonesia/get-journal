        ...
        <div class="row mt-5 flex-1" id="classroom_lists">
            @for ($i = 12; $i > 0; $i--)
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card mb-5"
                        style="background-image: linear-gradient(to bottom, rgba(0,0,0,.2), rgba(0,0,0,.8)), url({{ asset('assets/media/stock/600x400/img-1.jpg') }});background-size: cover; min-height:150px;">
