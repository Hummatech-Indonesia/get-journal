    ...
    <script>
        $(document).ready(function() {
            const dt_journals = $('#dt-journals').DataTable({
                ...
                dom: "<'row mt-2 justify-content-between'<'col-auto me-auto'B><'col-auto ms-auto custom-container-journal'>><'row mt-2 justify-content-between'<'col-sm-auto me-auto'l><'col-sm-auto me-start'f>><'row mt-2 justify-content-md-center'<'col-12'rt>><'row mt-2 justify-content-between'<'col-md-auto me-auto'i><'col-md-auto ms-auto'p>>",
                order: [
                    [1, 'asc']
                ],
                buttons: [
