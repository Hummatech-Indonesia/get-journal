...
interface JournalInterface extends GetJournalByUserInterface, GetJournalByClassroomInterface, StoreInterface, UpdateInterface, DeleteInterface, ShowInterface, ExportJournalInterface
{
}
